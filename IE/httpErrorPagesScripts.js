  ...
  if (document.getElementById) {
    ...
    if (ecBlock != undefined && ecBlock != null) {
      ...
      if (!changeImage || (elemImage != undefined && elemImage != null)) {
        if (
          ecBlock.currentStyle.display == "none" ||
          ecBlock.currentStyle.display == null ||
          ecBlock.currentStyle.display == ""
        ) {
          //shows the info.
...
function initHomepage() {
  ...
  if (
    ...
    if (protocolIndex - BeginURL > 7) urlresult = "";
...
function setTabInfo(tabInfoBlockID) {
  ...
  bElement.href =
    "javascript:expandCollapse('tabInfoBlockID', false); setTabInfo('tabInfoBlockID');";
